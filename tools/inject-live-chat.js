/**
 * Inject KIWL live chat widget script into all site HTML pages.
 */
const fs = require('fs');
const path = require('path');

const ROOT = path.join(__dirname, '..');
const MARKER = 'kiwl-live-chat.js';
...
function injectTag(prefix) {
  return `<script src="${prefix}wp-content/kiwl-chat/kiwl-live-chat.js" defer></script>`;
}
...
console.log(`Injected live chat: ${n}`);
